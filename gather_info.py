...
def ensureModulesInstalled():
    """Ensures required Python modules are installed."""
    required_modules = ["psutil", "speedtest-cli"]
    for module in required_modules:
        try:
            ...
            try:
                ...
                print(f"Please see your IT professional and ensure that you have speedtest-cli available for next time.")
                continue
...
def checkForSignificantChanges(csvFile, newInfo):
    ...
    try:
        with open(csvFile, mode='r') as file:
            ...
            lastScan = rows[-1]  # Compare to the previous scan
